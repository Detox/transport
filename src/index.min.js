...
O,verify:g.verify});k.on("error",function(a){h.fire("error",a)});k.once("ready",function(){h.fire("ready")})}function y(a,b,f){var d=this;null==f&&(f=10);if(!(this instanceof y))return new y(a,b,f);if(b<B)throw Error("Minimal supported packet size is "+B);D.call(this);this.h=new Map;this.l=new Map;this.j=new Map;this.i=new Map;this.c=new Map;this.w=new Map;this.a=u(P,b-2,z,Q,f).on("create_request",function(c){var b=c.address;var k=c.segment_id;var h=c.command_data;c=p(b,k);if(!d.h.has(c)){var l=g.Encryptor(!1,
