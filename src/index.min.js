...
e.i=+new Date,e.c&&e.l())});a.once("close",function(){e.fire("disconnected")});a.on("data",function(a){if(!e.b)if(e.c||a.length!==q)e.destroy();else{for(e.f.feed(a);e.f.have_more_data();){var b=e.f.get_data();a=b[0];b=b.subarray(1);a<e.g&&(b=e.w(b));e.fire("data",a,b)}e.c=!0;e.l()}})}function k(a,b,c,d){if(!(this instanceof k))return new k(a,b,c,d);p.call(this);this.a=v();this.c=v();this.g=new Set;this.l=a;this.m=b;this.i=c;this.j=d;this.f=new WeakMap}var z=f.array2string;var y=f.string2array;var n=
f.concat_arrays;var v=f.ArrayMap;var A=f.timeoutSet;var g=new Uint8Array(0);h.prototype={signal:function(a){this.b||this.a.signal({type:this.s?"answer":"offer",sdp:z(a)})},send:function(a,b){if(!(this.b||b.length>l)){if(a<this.g){if(b.length>r)return;b=this.v(b)}a=n([[a],b]);this.j.feed(a)}},destroy:function(){this.b||(this.b=!0,clearTimeout(this.h),this.a.destroy())},l:function(){var a=this;this.h=setTimeout(function(){if(!a.b)try{a.a.send(a.j.get_block()),a.c=!1,a.i=+new Date}catch(b){}},Math.max(0,
